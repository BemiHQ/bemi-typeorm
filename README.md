<div align="center">
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/BemiHQ/bemi-typeorm-example">Example</a>
    ·
    <a href="https://github.com/BemiHQ/bemi-typeorm/issues/new">Report Bug</a>
    ·
...
[Bemi](https://bemi.io) plugs into [TypeORM](https://github.com/typeorm/typeorm) and your existing PostgreSQL database to track data changes automatically. It unlocks robust context-aware audit trails and time travel querying inside your application.
...
See [an example repo](https://github.com/BemiHQ/bemi-typeorm-example) for TypeORM that automatically tracks all changes.
